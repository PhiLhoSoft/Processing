// newb question about array.remove <http://processing.org/discourse/yabb_beta/YaBB.cgi?board=Syntax;action=display;num=1229761245>
float colorIt = 255;
...
void setup() {
  size(1440,500, P2D);
  flock = new Flock();
  flock.addBoid(new Boid(new PVector(wdith/2,height/2),2.0f,0.05f));
  smooth();
  //
}

void draw() {
 //saveFrame("exports2/swarmfloat_255_####.png");
  background(255);
  flock.run();
}
