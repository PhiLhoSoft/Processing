...
void setup(){
  ...
  allContent[0] = new Content(#FFFFFF, "cpt_america.jpg", 25, false);
  allContent[1] = new Content(#FFFFFF, "batman.jpg", 25, false);
  allContent[2] = new Content(#FFFFFF, "wonderwoman.jpg", 25, false);
  allContent[3] = new Content(#FFFFFF, "superman.jpg", 25, false);
  allContent[4] = new Content(#FFFFFF, "superhero_name.gif", 25, true);
  activeContent = allContent[Integer.parseInt(getParameter("hero"))];

  allContent[0] = new Content(#FFFFFF, "kdockai1.gif", 25, false);
...
void updateContent(){
  ...
  sizeActive = activeContent.isSizeActive;
}
