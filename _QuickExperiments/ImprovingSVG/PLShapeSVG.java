...
public class PLShapeSVG extends PShape {
   ...
   */
  public PLShapeSVG(PApplet parent, String filename) {
...
PApplet.println("\n=== SVG File: " + filename + "\n");
   ...
   */
  public PLShapeSVG(XMLElement svg) {
    this(null, svg);
...
if (kid.getName() != null) PApplet.println("Adding child: " + kid.getName());
  ...
  protected PShape parseChild(XMLElement elem) {
    ...
    if (name.equals("g")) {
      ...
      shape = new PLShapeSVG(this, elem);

    } else if (name.equals("defs")) {
      // generally this will contain gradient info, so may
      // as well just throw it into a group element for parsing
      //return new BaseObject(this, elem);
PApplet.println("Defs: " + elem.getName());
      shape = new PLShapeSVG(this, elem);
...
//      }
  ...
  static class Gradient extends PLShapeSVG {
    ...
    public Gradient(PLShapeSVG parent, XMLElement properties) {
      super(parent, properties);
PApplet.println("Gradient: " + properties.getName());
  ...
  class LinearGradient extends Gradient {
    ...
    public LinearGradient(PLShapeSVG parent, XMLElement properties) {
      super(parent, properties);
