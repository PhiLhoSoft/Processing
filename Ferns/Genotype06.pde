...
class Genotype06 implements Genotype
{
	int m_direction = 1;
	color m_baseColor = #00A080;

	Genotype06() {}	// Default constructor, for default genotype
	Genotype06(boolean bReverse, color baseColor)
	{
	...
	float GetAngle(Object seg, boolean bIsLeft)
	{
		...
		case 'B': return m_direction * (bIsLeft ? -16.0 : +16.0);	// For branch
		default:  return 0;
		}
	}
